...
export const JobsFilterTop = ({ setError, setLoading, locations, setLocations, sectors, setSectors, jobTypes, setJobTypes, skills, setSkills }) => {
	...
	return (
		<>
			<Button onClick={onOpen} fontWeight="medium" size="lg" bg="dBlue.300" color="gray.50" rounded="full" _hover={{bg:"dBlue.400"}}>Filter Opportunites</Button>

			<Modal closeOnOverlayClick={false} isOpen={isOpen} onClose={onClose} isCentered scrollBehavior="inside">
				<ModalOverlay />
				<ModalContent 
					margin={{
						base: "3"
