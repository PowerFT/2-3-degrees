...
export const Header = ({
  ...
  blogAuthor,
  pageHeaderBgCol,
  pageHeaderTextColour,
}) => {
  const hidden =
    pagetype === 'home' || pagetype === 'connect-home' || pagetype === 'login';
    ...
    >
      ...
      >
        ...
        <Text
          ...
          fontSize={{
            base: pagetype === 'blog' ? 'sm' : 'xl',
            lg: pagetype === 'blog' ? 'sm' : '2xl',
          }}
          mt="6"
          maxW="2xl"
          mx={{ base: 'auto', lg: 'unset' }}
      ...
      {imageData && (
        <Box
          className="pageblock__header--imagecontainer"
          position="relative"
          w="full"
          h="full"
          flex="1 1 50%"
