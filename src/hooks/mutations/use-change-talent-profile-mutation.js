...
const CHANGE_TALENT_PROFILE = gql`
  mutation changeTalentProfile(
...
export const useChangeTalentProfileMutation = () => {
  const [mutation, mutationResults] = useMutation(CHANGE_TALENT_PROFILE);
